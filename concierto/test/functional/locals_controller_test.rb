...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { direccGoogle: @local.direccGoogle, direccion: @local.direccion, distrito_id: @local.distrito_id, nombre: @local.nombre, telFijo: @local.telFijo }
    end
  ...
  test "should update local" do
    put :update, id: @local, local: { direccGoogle: @local.direccGoogle, direccion: @local.direccion, distrito_id: @local.distrito_id, nombre: @local.nombre, telFijo: @local.telFijo }
    assert_redirected_to local_path(assigns(:local))
  end
